...
for objType, objName in [('offline', 'AntiKt4'), ('gFEX', 'gTowers_central'), ('gFEX', 'gBlocks_central')]:
  for kinematic, xaxis_label in zip(['Pt_s_0', 'Eta_0', 'Phi_0'], ['p_{T} [GeV]', '#eta', '#phi']):
    tex = []
    colors = cycle(colorbrewer.qualitative.Set1_9.colors)
    c = ROOT.TCanvas()
    if kinematic in ['Pt_s_0']: c.SetLogy()
